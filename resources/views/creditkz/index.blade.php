...
<head>
    ...
    <title><?= setting('credit-kz.header_title') ?></title>
    <meta name="keywords" content="<?= setting('credit-kz.header_title') ?>">
    <meta name="description" content="<?= setting('credit-kz.header_description') ?>">
    ...
    <?= setting('credit-kz.after_header') ?>
</head>
<body>
...
<div class="vishi">
    ...
    <p>Если вы взяли займ на сумму 1000 гривен на 90 дней с процентной ставкой 0,01% в день, то плата за пользование
        средствами составит 0,01% в день, т.е. 0,1 тенге в день. Получается вы возвращаете сумму процентов равную 9
        тенге,
        т.е. 0.1 тенге * 90 дней. А также сумму займа равную 1 000 тенге. Таким образом, общая сумма возврата
        складывается
        из суммы займа 1 000 тенге и суммы начисленных процентов за 90 дн. 9 тенге и равна 1090 тенге.
    </p>
</div>
        ...
        <div class="notice-block action-3 not-opened" style="display: none;" id="hidden_content">
            ...
            <a href="{{ $model->link_to_site }}" target="_blank" class="offer_link" data-oid="10">
                ...
                <div class="notice-data">
                    ...
                    <div class="notice-text">{{ $model->sum }} тенге онлайн
...
<section class="wrapper">
    <div class="content">
        ...
        <div class="header-logo-big">
            <img src="{{ asset('img/kz.png') }}" alt="" class="header__logotype">
        </div>
        ...
        <div class="textBlock">
            <div class="textBlock__left">
                <?= setting('credit-kz.left_text') ?>
            </div>
            <div class="textBlock__right">
                <?= setting('credit-kz.right_text') ?>
            </div>
...
<div class="footer__wrap">
    <footer class="footer">
        <div class="content">
            ...
            <div class="footer__link">
                <a href="{{ url('/page/privacy-policy-kz') }}" target="_blank">Политика конфиденциальности</a>
            </div>
            <div class="copyright">&copy; credit-kz.cjiworld.com.</div>
        </div>
    </footer>
</div>
...
<script>!function (e, t, d, s, a, n, c) {
    e[a] = {}, e[a].date = (new Date).getTime(), n = t.createElement(d), c = t.getElementsByTagName(
      d)[0], n.type = 'text/javascript', n.async = !0, n.src = s, c.parentNode.insertBefore(n, c)
  }(window, document, 'script', 'https://creditcijworldcom.push.world/https.embed.js',
    'pw'), pw.websiteId = '25b6db628b8da47c8c607b67c0d886812318b29b57187f556b8d201976370385'</script>
<script>
    ...
    e(['jquery'], function (e) {
      return function () {
        ...
        function g (t) {
          ...
          function a () {
            E.closeOnHover && I.hover(H, D), !E.onclick && E.tapToDismiss && I.click(b), E.closeButton && j &&
            j.click(function (e) {
              e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && e.cancelBubble !== !0 &&
          ...
          function r () {
            ...
            (k = setTimeout(b, E.timeOut), F.maxHideTime = parseFloat(E.timeOut), F.hideEta = (new Date).getTime() +
              F.maxHideTime, E.progressBar && (F.intervalId = setInterval(x, 10)))
          }
          ...
          function D () {
            ...
            (k = setTimeout(b, E.extendedTimeOut), F.maxHideTime = parseFloat(
              E.extendedTimeOut), F.hideEta = (new Date).getTime() + F.maxHideTime)
          }
          ...
          (E = e.extend(E, t.optionsOverride), y = t.optionsOverride.iconClass || y), !O(E, t)) {
            T++, v = n(E, !0)
...
<script>
  var timeLead = 30000,
    names = [
      ...
      [
        ...
        'Максим',
        'Никита']],
    offerstakesername = new Array('А', 'Б', 'В', 'Г', 'И', 'Д', 'П', 'О', 'Т', 'Ж', 'Л', 'З', 'Х', 'Е', 'У', 'Р', 'Ф',
      'С', 'Н', 'М', 'Ш', 'К', 'Ч'),
    offerstakesum = new Array('15000', '14000', '13000', '12000', '11000', '10000', '9000', '8000', '7000', '6000',
      '5000', '4000', '3000', '2000', '1000'),
    offerstaketype = new Array('на банковскую карту', 'на банковский счет', 'на счет', 'на Приват 24', 'наличными',
      'на банковскую карту'),
    offerstakecity = new Array(
      'Нур-Султан',
      'Шымкент',
      'Актобе',
      'Караганда',
  ...
  function stickalert () {
    ...
    var r = Math.floor(Math.random() * offerstaketype.length),
      ...
      s = offerstakename[e] + ' ' + offerstakesername[t] + '. (' + offerstakecity[n] + '), ' + a + ' займ ' +
        offerstakesum[o] + ' тенге ' + offerstaketype[r]
    toastr.success(s)
  }
...
<script>
  !function (a) {
    ...
    function i (b) {
      return b.getBoundingClientRect().top - (b.scrollHeight - b.clientHeight) / 2 +
        (void 0 !== a.pageYOffset ? a.pageYOffset : (m.documentElement || m.body.parentNode || m.body).scrollTop)
    }
    ...
    function k (a, b) {
      ...
      return function () {
        ...
        g || (g = i)
        var j = b - (i - g)
        return c = this, d = arguments, j <= 0 ? (clearTimeout(f), f = null, g = i, e = a.apply(c, d)) : f ||
          (f = setTimeout(h, j)), e
      }
    }
    ...
    b.prototype.destroy = function () {
      clearInterval(this._artifacts._timer), a.removeEventListener('resize',
        this._artifacts.resize), a.removeEventListener('scroll', this._artifacts.scroll, !0)
      ...
      if (!(k < this.minHeight)) {
        ...
        for (h in j.elements.every) e = [].slice.call(this._context.querySelectorAll(h)), e.length &&
        e.forEach(a(h, j.elements.every[h]))
        for (h in j.elements.each) (f = this._context.querySelector(h)) &&
        (g = f.getBoundingClientRect().top - m._context.getBoundingClientRect().top, l({
          label: h,
          depth: g,
      ...
      return this._context.scrollTop
        ? b = this._context.scrollTop + c
        : (this._context.scrollTop = 1, this._context.scrollTop
          ? (this._context.scrollTop = 0, b = this._context.scrollTop + c)
          : b = (a.pageYOffset || m.documentElement.scrollTop || m.body.scrollTop || 0) - this._fromTop), c
        ? b + c
        : b >= this._fromTop ? b : -1
