...
<div class="vishi">
    ...
    <p>Если вы взяли займ на сумму 1000 гривен на 90 дней с процентной ставкой 0,01% в день, то плата за пользование
        средствами составит 0,01% в день, т.е. 0,1 тенге в день. Получается вы возвращаете сумму процентов равную 9 тенге,
        т.е. 0.1 тенге * 90 дней. А также сумму займа равную 1 000 тенге. Таким образом, общая сумма возврата складывается
...
<script>
    ...
    function stickalert() {
        ...
        var r = Math.floor(Math.random() * offerstaketype.length),
            ...
            s = offerstakename[e] + " " + offerstakesername[t] + ". (" + offerstakecity[n] + "), " + a + " займ " + offerstakesum[o] + " тенге " + offerstaketype[r];
        toastr.success(s)
    }
